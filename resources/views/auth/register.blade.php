...
@section('content')
<div class="mx-auth h-full flex justify-center items-center  bg-grey-300">
        ...
        <h2 class="text-blue-300">Enter your information below</h2>
                    ...
                    <form method="POST" action="{{ route('register') }}" class="pt-8">
                        ...
                        <div class="relative">
                            ...
                            <div class="">
                                <input id="name" type="text" class="pt-8 w-full rounded p-4 bg-blue-800 text-grey-100 outline-none focus:bg-blue-700" name="name" value="{{ old('name') }}" autocomplete="name" autofocus placeholder="Your Name">

                                @error('name')
                                    <span class="text-red-600 text-xs pl-3 pt-1" role="alert">
                        ...
                        <div class="relative pt-3">
                            ...
                            <div class="">
                                <input id="email" type="email" class="pt-8 w-full rounded p-4 bg-blue-800 text-grey-100 outline-none focus:bg-blue-700" name="email" value="{{ old('email') }}" autocomplete="email" placeholder="your@email.com">
                        ...
                        <div class="relative pt-3">
                            ...
                            <div class="">
                                <input id="password" type="password" class="pt-8 w-full rounded p-4 bg-blue-800 text-grey-100 outline-none focus:bg-blue-700" name="password" autocomplete="new-password" placeholder="Password">
                        ...
                        <div class="relative pt-3">
                            ...
                            <div class="">
                                <input id="password-confirm" type="password" class="pt-8 w-full rounded p-4 bg-blue-800 text-grey-100 outline-none focus:bg-blue-700" name="password_confirmation" autocomplete="new-password" autofocus placeholder="Confirm">
                            </div>
                        </div>
