...
<div class="mx-auth h-full flex justify-center items-center  bg-grey-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <h1 class="text-white text-3xl pt-8">Wecome Back</h1>
        <h2 class="text-blue-300">Enter your credentials below</h2>
                    ...
                    <form method="POST" action="{{ route('login') }}" class="pt-8">
                        ...
                        <div class="relative">
                            ...
                            <div class="">
                                <input id="email" type="email" class="pt-8 w-full rounded p-4 bg-blue-800 text-grey-100 outline-none focus:bg-blue-700" name="email" value="{{ old('email') }}" autocomplete="email" autofocus placeholder="your@email.com">
                        ...
                        <div class="relative pt-3">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="pt-8 w-full rounded p-4 bg-blue-800 text-grey-100 outline-none focus:bg-blue-700" name="password" autocomplete="current-password">
