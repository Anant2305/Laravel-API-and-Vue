<template>
    <div class="h-screen bg-white">
        <div class="flex">
            <div class="pl-6 w-48 bg-gray-200 h-screen border-r-2 border-gray-400" >
                <nav class="pt-4">
                    <router-link to="/">
                    ...
                    <p class="text-gray-500 pt-12 text-xs uppercase font-bold">Create</p>
                    ...
                    <p class="text-gray-500 pt-12 text-xs uppercase font-bold">General</p>
                    ...
                    <p class="text-gray-500 pt-12 text-xs uppercase font-bold">Settings</p>
