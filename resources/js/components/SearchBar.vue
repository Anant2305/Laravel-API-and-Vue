<template>
    <div>
        ...
        <div class="relative z-10">
            ...
            <input type="text" class="w-54 mr-6 bg-grey-200 border border-gray-400 pl-8 pr-3 py-1 rounded-full text-sm focus:outline-none focus:border-blue-500 focus:shadow focus:bg-gray-100" placeholder="Search...." id="searchTerm" v-model="searchTerm" @input="search" @focus="focus = true">
