    ...
    <div>
        ...
        <div class="flex justify-between">
            ...
            <div>
                ...
                <a href="#" class="px-4 py-2 rounded text-red-500 border border-red-500 text-sm font-bold" @click="modal = ! modal">Delete</a>
        ...
        <p class="pt-6 text-grey-600 font-bold uppercase text-sm">Contact</p>
        <p class="pt-2 text-blue-400">{{contact.email}}</p>
        <p class="pt-6 text-grey-600 font-bold uppercase text-sm">Company</p>
        <p class="pt-2 text-blue-400">{{contact.company}}</p>
        <p class="pt-6 text-grey-600 font-bold uppercase text-sm">Birthday</p>
